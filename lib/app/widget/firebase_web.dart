...
import 'package:firebase_auth/firebase_auth.dart' as authApi;
...
class FirebaseAuthDriver extends FirebaseAuthDriverInterface {
  ...
  authApi.FirebaseAuth get instance => authApi.FirebaseAuth.instance;
  ...
  final authApi.FirebaseAuth _auth = authApi.FirebaseAuth.instance;
  ...
  Future<String> signInWithGoogle() async {
    ...
    final authApi.AuthCredential credential =
        authApi.GoogleAuthProvider.credential(
      accessToken: googleSignInAuthentication.accessToken,
      idToken: googleSignInAuthentication.idToken,
    );
    final /*AuthResult*/ authResult =
        await _auth.signInWithCredential(credential);
    authApi.User user = authResult.user;
    currentUser = user;
